...
Apply unsupervised learning algorithms to cluster cities into sustainability performance groups

Identify high-risk, moderate, and high-performing sustainability city clusters

Support policy targeting, infrastructure funding prioritization, and ESG risk scoring

⚙️ Methodology

Algorithms: K-Means Clustering, Hierarchical Clustering, Principal Component Analysis (PCA)

Data Sources: Global city-level environmental, infrastructure, housing, transport, and climate datasets

Tools: Python, Pandas, NumPy, Scikit-learn, GeoPandas, Folium, SQL
...
City sustainability cluster assignments

Interactive sustainability maps highlighting cluster risk levels
...
ESG and climate-risk investment analysis

Infrastructure funding prioritization

Environmental policy and sustainability benchmarking
